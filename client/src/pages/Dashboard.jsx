    ...
    <div dir="rtl" className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <main className="flex-1 overflow-hidden" style={{ margin: '3px' }}>
        <div className="h-full">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-[1%] h-full" style={{ marginRight: 'calc(13% + 3px)' }}>
            <p className="text-gray-400 text-sm">محتوای صفحه اصلی</p>
          </div>
        </div>
      </main>

      <div className="fixed top-16 right-0 overflow-y-auto" style={{ width: '13%', bottom: '3rem', paddingTop: '3px' }}>
